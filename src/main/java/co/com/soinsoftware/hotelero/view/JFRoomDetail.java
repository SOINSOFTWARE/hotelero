...
public class JFRoomDetail extends JDialog {
	...
	private void showButtonsByRoomStatus(final Room room, final RoomStatus roomStatus) {
		if (roomStatus.equals(this.roomStatusBooked)) {
			...
			if (DateUtils.isSameDay(currentDate, this.jdcInitialDate.getDate()) && this.validateRoomIsAvailable(room)) {
	...
	private boolean validateRoomIsAvailable(final Room room) {
		...
		final List<Invoice> notEnabledSet = this.invoiceController.selectNotEnabled();
	...
	private void initComponents() {
		...
		jpClientLayout.setHorizontalGroup(
				jpClientLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jpClientLayout
						...
						.addContainerGap().addGroup(jpClientLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jpClientLayout
										...
										.addComponent(jlbSiteFrom).addComponent(jtfSiteFrom)
										.addComponent(jlbSiteTo).addComponent(jtfSiteTo).addComponent(jlbCompany)
										.addComponent(jlbInitialDate).addComponent(jcbCompany, 0, 200, Short.MAX_VALUE))
