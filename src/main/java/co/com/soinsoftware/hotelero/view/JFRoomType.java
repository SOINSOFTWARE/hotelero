...
import co.com.soinsoftware.hotelero.controller.RoomTypeController;
import co.com.soinsoftware.hotelero.entity.RoomType;
import co.com.soinsoftware.hotelero.util.RoomTypeTableModel;
 ...
 * @version 1.0.1
 */
public class JFRoomType extends JDialog {
	...
	public JFRoomType() {
		try {
			this.controller = new RoomTypeController();
	...
	private void refreshTableData() {
		final List<RoomType> roomTypeList = this.controller.selectRoomTypes();
		final TableModel model = new RoomTypeTableModel(roomTypeList);
	...
	private List<RoomType> getRoomTypeListFromTable() {
		final TableModel model = this.jtbList.getModel();
		return ((RoomTypeTableModel) model).getRoomTypeList();
	}

	private boolean hasRoomTypeToBeUpdated(final List<RoomType> roomTypeList) {
		boolean hasElements = false;
		for (final RoomType roomType : roomTypeList) {
			if ((roomType.getNewName() != null
					&& !roomType.getNewName().equals("") && !roomType
					.getNewName().equals(roomType.getName()))
					|| (roomType.getNewCode() != null
							&& !roomType.getNewCode().equals("") && !roomType
							.getNewCode().equals(roomType.getCode()))) {
				hasElements = true;
				break;
			}
		}
	...
	private boolean hasRoomTypeToBeDeleted(final List<RoomType> roomTypeList) {
		boolean hasElements = false;
		for (final RoomType roomType : roomTypeList) {
	...
	private void initComponents() {
		...
		jlbTitle.setText("Tipos de habitaciones");
		...
		jpNewRecord.setBorder(javax.swing.BorderFactory.createTitledBorder(
				null, "Nuevo",
		...
		javax.swing.GroupLayout jpNewRecordLayout = new javax.swing.GroupLayout(
				jpNewRecord);
		jpNewRecord.setLayout(jpNewRecordLayout);
		jpNewRecordLayout
				.setHorizontalGroup(jpNewRecordLayout
						.createParallelGroup(
						...
						.addGroup(
								jpNewRecordLayout
										...
										.addContainerGap()));
		jpNewRecordLayout
				.setVerticalGroup(jpNewRecordLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jpNewRecordLayout
		...
		jpList.setBorder(javax.swing.BorderFactory.createTitledBorder(null,
				"Listado",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
				javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Verdana", 1, 12))); // NOI18N
		...
		javax.swing.GroupLayout jpListLayout = new javax.swing.GroupLayout(
				jpList);
		jpList.setLayout(jpListLayout);
		jpListLayout
				.setHorizontalGroup(jpListLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								jpListLayout
	...
	private void jbtSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jbtSaveActionPerformed
		if (this.validateDataForSave()) {
			...
			if (confirmation == JOptionPane.OK_OPTION) {
				final String code = this.jtfCode.getText();
				final String name = this.jtfName.getText();
				this.controller.saveRoomType(code, name);
	...
	private void jbtUpdateActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jbtUpdateActionPerformed
		final List<RoomType> roomTypeList = this.getRoomTypeListFromTable();
		if (roomTypeList != null && this.hasRoomTypeToBeUpdated(roomTypeList)) {
			final int confirmation = ViewUtils.showConfirmDialog(this,
			...
			if (confirmation == JOptionPane.OK_OPTION) {
				for (final RoomType roomType : roomTypeList) {
					...
					if (roomType.getNewName() != null
							&& !roomType.getNewName().equals("")
							&& !roomType.getNewName()
									.equals(roomType.getName())) {
						roomType.setName(roomType.getNewName());
						edited = true;
					}
					if (roomType.getNewCode() != null
							&& !roomType.getNewCode().equals("")
							&& !roomType.getNewCode()
									.equals(roomType.getCode())) {
						roomType.setCode(roomType.getNewCode());
						edited = true;
					}
					if (edited) {
						roomType.setUpdated(new Date());
						this.controller.saveRoomType(roomType);
					}
				}
	...
	private void jbtDeleteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jbtDeleteActionPerformed
		final List<RoomType> roomTypeList = this.getRoomTypeListFromTable();
		if (roomTypeList != null && this.hasRoomTypeToBeDeleted(roomTypeList)) {
			final int confirmation = ViewUtils.showConfirmDialog(this,
