...
import com.soinsoftware.hotelero.core.controller.RoomTypeController;
...
public class JFRoomType extends JDialog {
	...
	private void refreshTableData() {
		final List<RoomType> roomTypeList = this.controller.select();
	...
	private void jbtSaveActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jbtSaveActionPerformed
		if (this.validateDataForSave()) {
			...
			if (confirmation == JOptionPane.OK_OPTION) {
				final String code = this.jtfCode.getText();
				final String name = this.jtfName.getText();
				this.controller.save(code, name);
