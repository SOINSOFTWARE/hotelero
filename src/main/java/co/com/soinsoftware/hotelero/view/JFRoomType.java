...
public class JFRoomType extends JDialog {
	...
	private boolean hasRoomTypeToBeUpdated(final List<RoomType> roomTypeList) {
		...
		for (final RoomType roomType : roomTypeList) {
			if ((roomType.getNewName() != null && !roomType.getNewName().equals("")
					&& !roomType.getNewName().equals(roomType.getName()))
					|| (roomType.getNewCode() != null && !roomType.getNewCode().equals("")
							&& !roomType.getNewCode().equals(roomType.getCode()))) {
				hasElements = true;
				break;
			}
		}
	...
	private void initComponents() {
		...
		jpNewRecord.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nuevo",
		...
		jpList.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Listado",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Verdana", 1, 12))); // NOI18N
		...
		if (roomTypeList != null && this.hasRoomTypeToBeUpdated(roomTypeList)) {
			...
			if (confirmation == JOptionPane.OK_OPTION) {
				for (final RoomType roomType : roomTypeList) {
					...
					if (roomType.getNewCode() != null && !roomType.getNewCode().equals("")
							&& !roomType.getNewCode().equals(roomType.getCode())) {
